/*!
 * korean-lunar-calendar v0.4.0 — 한국천문연구원(KASI) 음양력 자료 기반 변환 라이브러리
 * https://github.com/usingsky/korean_lunar_calendar_js
 * Copyright (c) usingsky. Released under the MIT License.
 *
 * 브라우저에서 쓰려고 module.exports 대신 전역(window.KoreanLunarCalendar)으로 노출하도록
 * 감싼 것 외에는 원본 그대로다. 갱신할 때도 이 두 줄만 바꾸면 된다.
 * 지원 범위: 음력 1000-01-01 ~ 2050-11-18 / 양력 1000-02-13 ~ 2050-12-31
 *
 * 왜 내장했나: 브라우저 내장 Intl 의 중국식 음력은 한국 음력과 하루 어긋나는 해가 있다
 * (예: 2028년 설날을 1/26 으로 낸다. 실제는 1/27). 한국 음력을 쓰려면 KASI 자료가 필요하다.
 */
(function (global) {
'use strict';
...
//#endregion
  ...
  global.KoreanLunarCalendar = KoreanLunarCalendar;
