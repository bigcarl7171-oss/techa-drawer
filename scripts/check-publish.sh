...
for b in build-home-tools build-home-curation build-tool-hub build-chrome build-message-phrases build-related build-posts build-blog-products build-tool-products; do
